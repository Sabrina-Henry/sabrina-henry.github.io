...
<div class="plotly-embed">
  <iframe
    src="Interactive_figs/surface_plot.html"
...
These low-confidence variants expose decision boundaries and can be reused as training augmentations. Incorporating them during retraining improves robustness to noise and adversarial perturbations, linking interpretability and model reliability.
...
**Paper:** Self-Guided Integrated Gradient Method for Attribution (preprint)  
**Code:** GitHub repository  
**Contact:** sjh9@hw.ac.uk
